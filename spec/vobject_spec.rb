...
=begin
  it 'should parse vCard properly' do
    ...
    vobj_json = Vcalendar.new('2.0').parse(vcf).to_json
...
=end
  ...
  it 'should process RFC6868 caret parameters' do
    ...
    vobj_json = Vcalendar.new('2.0').parse(ics).to_json
  ...
  it 'should enforce proper Bin64 encoding' do
    ...
    expect { Vcalendar.new('2.0').parse(ics)}.to raise_error(/Malformed binary coding for property ATTACH/)
  end
  ...
  it 'should require at least one component' do
    ...
    expect { Vcalendar.new('2.0').parse(ics)}.to raise_error(Rsec::SyntaxError)
  end
  ...
  it 'should reject spurious boolean value' do
    ...
    expect { Vcalendar.new('2.0').parse(ics)}.to raise_error(/Type mismatch for property X_MAYBE/)
  end
  ...
  it 'should reject spurious float value' do
    ...
    expect { Vcalendar.new('2.0').parse(ics)}.to raise_error(/Type mismatch for property X_INVALID_FLOAT/)
  end
  ...
  it 'should parse iCalendar properly' do
    ...
    expect { Vcalendar.new('2.0').parse(ics)}.to raise_error(/Type mismatch for property X_INVALID,/)
  end
  ...
  it 'should disallow UID in an ALARM component' do
    ...
    expect { Vcalendar.new('2.0').parse(ics)}.to raise_error(/Invalid property/)
  end

  it 'should disallow LANGUAGE parameter in a TRIGGER component' do
    ics = File.read "spec/examples/spurious_param.ics"
    expect { Vcalendar.new('2.0').parse(ics)}.to raise_error(/parameter given/)
  end
