...
=end
  ...
  it 'should recognise VAVAILABILITY component' do
    ...
    vobj_json = Vcalendar.parse(ics, true).to_json
    exp_json = JSON.load(File.read "spec/examples/vcalendar/availability2.json")
    expect(vobj_json).to include_json(exp_json)
  end
  it 'should roundtrip VCARD for VAVAILABILITY component' do
    ics = File.read "spec/examples/vcalendar/availability2.ics"
  ...
  it 'should permit multiple VEVENT components' do
    ...
    vobj_json = Vcalendar.parse(ics, true).to_json
    exp_json = JSON.load(File.read "spec/examples/vcalendar/availability3.json")
    expect(vobj_json).to include_json(exp_json)
  end
  ...
  it 'should parse iCalendar properly 2' do
    ...
    vobj_json = Vcalendar.parse(ics, true).to_json
    exp_json = JSON.load(File.read "spec/examples/vcalendar/example2.json")
    expect(vobj_json).to include_json(exp_json)
  end
  ...
  it 'should parse iCalendar properly 3' do
    ...
    vobj_json = Vcalendar.parse(ics, true).to_json
    exp_json = JSON.load(File.read "spec/examples/vcalendar/example3.json")
    expect(vobj_json).to include_json(exp_json)
  end
  ...
  it 'should parse iCalendar properly 4' do
    ...
    vobj_json = Vcalendar.parse(ics, true).to_json
    exp_json = JSON.load(File.read "spec/examples/vcalendar/example4.json")
    expect(vobj_json).to include_json(exp_json)
  end
  ...
  it 'should parse iCalendar properly 5' do
    ...
    vobj_json = Vcalendar.parse(ics, true).to_json
    exp_json = JSON.load(File.read "spec/examples/vcalendar/example5.json")
    expect(vobj_json).to include_json(exp_json)
  end
  ...
  it 'should parse iCalendar properly 6' do
    ...
    vobj_json = Vcalendar.parse(ics, true).to_json
    exp_json = JSON.load(File.read "spec/examples/vcalendar/example6.json")
    expect(vobj_json).to include_json(exp_json)
  end
  ...
  it 'should parse iCalendar properly 7' do
    ...
    vobj_json = Vcalendar.parse(ics, true).to_json
    exp_json = JSON.load(File.read "spec/examples/vcalendar/example7.json")
    expect(vobj_json).to include_json(exp_json)
  end
  ...
  it 'should parse iCalendar properly with blank description' do
    ...
    vobj_json = Vcalendar.parse(ics, true).to_json
    exp_json = JSON.load(File.read "spec/examples/vcalendar/blank_description.json")
    expect(vobj_json).to include_json(exp_json)
  end
  ...
  it 'should process VALUE:BOOLEAN' do
    ...
    vobj_json = Vcalendar.parse(ics, true).to_json
    exp_json = JSON.load(File.read "spec/examples/vcalendar/boolean1.json")
    expect(vobj_json).to include_json(exp_json)
  end
  ...
  it 'should allow repeated components' do
    ...
    vobj_json = Vcalendar.parse(ics, true).to_json
    exp_json = JSON.load(File.read "spec/examples/vcalendar/component.json")
    expect(vobj_json).to include_json(exp_json)
  end
  ...
  it 'should parse iCalendar properly with Daily Recur' do
    ...
    vobj_json = Vcalendar.parse(ics, true).to_json
    exp_json = JSON.load(File.read "spec/examples/vcalendar/daily_recur.json")
    expect(vobj_json).to include_json(exp_json)
  end
  ...
  it 'should parse iCalendar properly with Dates' do
    ...
    vobj_json = Vcalendar.parse(ics, true).to_json
    exp_json = JSON.load(File.read "spec/examples/vcalendar/dates.json")
    expect(vobj_json).to include_json(exp_json)
  end
  ...
  it 'should parse iCalendar properly with Day Long Recur Yearly' do
    ...
    vobj_json = Vcalendar.parse(ics, true).to_json
    exp_json = JSON.load(File.read "spec/examples/vcalendar/day_long_recur_yearly.json")
    expect(vobj_json).to include_json(exp_json)
  end
  ...
  it 'should parse iCalendar properly with Duration instead of DTEND' do
    ...
    vobj_json = Vcalendar.parse(ics, true).to_json
    exp_json = JSON.load(File.read "spec/examples/vcalendar/duration_instead_of_dtend.json")
    expect(vobj_json).to include_json(exp_json)
  end
  ...
  it 'should process VALUE:FLOAT' do
    ...
    vobj_json = Vcalendar.parse(ics, true).to_json
    exp_json = JSON.load(File.read "spec/examples/vcalendar/float.json")
    expect(vobj_json).to include_json(exp_json)
  end
  ...
  it 'should parse iCalendar properly with forced types' do
    ...
    vobj_json = Vcalendar.parse(ics, true).to_json
    exp_json = JSON.load(File.read "spec/examples/vcalendar/forced_types.json")
    expect(vobj_json).to include_json(exp_json)
  end
  ...
  it 'should parse iCalendar properly with Google Birthdays' do
    ...
    vobj_json = Vcalendar.parse(ics, true).to_json
    exp_json = JSON.load(File.read "spec/examples/vcalendar/google_birthday.json")
    expect(vobj_json).to include_json(exp_json)
  end
  ...
  it 'should parse iCalendar properly with Integers' do
    ...
    vobj_json = Vcalendar.parse(ics, true).to_json
    exp_json = JSON.load(File.read "spec/examples/vcalendar/integer.json")
    expect(vobj_json).to include_json(exp_json)
  end
  ...
  it 'should parse Minimal iCalendar properly' do
    ...
    vobj_json = Vcalendar.parse(ics, true).to_json
    exp_json = JSON.load(File.read "spec/examples/vcalendar/minimal.json")
    expect(vobj_json).to include_json(exp_json)
  end
  ...
  it 'should parse iCalendar properly with Multiple RRULE' do
    ...
    vobj_json = Vcalendar.parse(ics, true).to_json
    exp_json = JSON.load(File.read "spec/examples/vcalendar/multiple_rrules.json")
    expect(vobj_json).to include_json(exp_json)
  end
  ...
  it 'should parse iCalendar properly with multiple values' do
    ...
    vobj_json = Vcalendar.parse(ics, true).to_json
    exp_json = JSON.load(File.read "spec/examples/vcalendar/multivalue.json")
    expect(vobj_json).to include_json(exp_json)
  end
  ...
  it 'should parse iCalendar properly with only DTSTART date' do
    ...
    vobj_json = Vcalendar.parse(ics, true).to_json
    exp_json = JSON.load(File.read "spec/examples/vcalendar/only_dtstart_date.json")
    expect(vobj_json).to include_json(exp_json)
  end
  ...
  it 'should parse iCalendar properly with only DTSTART time' do
    ...
    vobj_json = Vcalendar.parse(ics, true).to_json
    exp_json = JSON.load(File.read "spec/examples/vcalendar/only_dtstart_time.json")
    expect(vobj_json).to include_json(exp_json)
  end
  ...
  it 'should parse iCalendar properly' do
    ...
    vobj_json = Vcalendar.parse(ics, true).to_json
    exp_json = JSON.load(File.read "spec/examples/vcalendar/parserv2.json")
    expect(vobj_json).to include_json(exp_json)
  end
  ...
  it 'should parse iCalendar properly with periods' do
    ...
    vobj_json = Vcalendar.parse(ics, true).to_json
    exp_json = JSON.load(File.read "spec/examples/vcalendar/period.json")
    expect(vobj_json).to include_json(exp_json)
  end
  ...
  it 'should parse iCalendar properly with property params' do
    ...
    vobj_json = Vcalendar.parse(ics, true).to_json
    exp_json = JSON.load(File.read "spec/examples/vcalendar/property_params.json")
    expect(vobj_json).to include_json(exp_json)
  end
  ...
  it 'should parse iCalendar properly with quoted params' do
    ...
    vobj_json = Vcalendar.parse(ics, true).to_json
    exp_json = JSON.load(File.read "spec/examples/vcalendar/quoted_params.json")
    expect(vobj_json).to include_json(exp_json)
  end
  ...
  it 'should parse iCalendar properly with RECUR' do
    ...
    vobj_json = Vcalendar.parse(ics, true).to_json
    exp_json = JSON.load(File.read "spec/examples/vcalendar/recur.json")
    expect(vobj_json).to include_json(exp_json)
  end
  ...
  it 'should parse iCalendar properly with RECUR instances' do
    ...
    vobj_json = Vcalendar.parse(ics, true).to_json
    exp_json = JSON.load(File.read "spec/examples/vcalendar/recur_instances.json")
    expect(vobj_json).to include_json(exp_json)
  end
  ...
  it 'should parse iCalendar properly with finite RECUR instances' do
    ...
    vobj_json = Vcalendar.parse(ics, true).to_json
    exp_json = JSON.load(File.read "spec/examples/vcalendar/recur_instances_finite.json")
    expect(vobj_json).to include_json(exp_json)
  end
  ...
  it 'should parse iCalendar properly' do
    ...
    vobj_json = Vcalendar.parse(ics, true).to_json
    exp_json = JSON.load(File.read "spec/examples/vcalendar/rfc.json")
    expect(vobj_json).to include_json(exp_json)
  end
  it 'should roundtrip VCARD' do
    ics = File.read "spec/examples/vcalendar/rfc.ics"
  ...
  it 'should parse iCalendar properly with TIME' do
    ...
    vobj_json = Vcalendar.parse(ics, true).to_json
    exp_json = JSON.load(File.read "spec/examples/vcalendar/time.json")
    expect(vobj_json).to include_json(exp_json)
  end
  ...
  it 'should parse iCalendar properly with GMT TZID' do
    ...
    vobj_json = Vcalendar.parse(ics, true).to_json
    exp_json = JSON.load(File.read "spec/examples/vcalendar/tzid_with_gmt.json")
    expect(vobj_json).to include_json(exp_json)
  end
  ...
  it 'should parse iCalendar properly with unfolding properties' do
    ...
    vobj_json = Vcalendar.parse(ics, true).to_json
    exp_json = JSON.load(File.read "spec/examples/vcalendar/unfold_properties.json")
    expect(vobj_json).to include_json(exp_json)
  end
  ...
  it 'should parse iCalendar properly with negative zero UTC' do
    ...
    vobj_json = Vcalendar.parse(ics, true).to_json
    exp_json = JSON.load(File.read "spec/examples/vcalendar/utc_negative_zero.json")
    expect(vobj_json).to include_json(exp_json)
  end
  ...
  it 'should parse iCalendar properly with UTC offset' do
    ...
    vobj_json = Vcalendar.parse(ics, true).to_json
    exp_json = JSON.load(File.read "spec/examples/vcalendar/utc_offset.json")
    expect(vobj_json).to include_json(exp_json)
  end
  ...
  it 'should parse iCalendar properly' do
    ...
    vobj_json = Vcalendar.parse(ics, true).to_json
    exp_json = JSON.load(File.read "spec/examples/vcalendar/values.json")
    expect(vobj_json).to include_json(exp_json)
  end
  it 'should roundtrip VCARD' do
    ics = File.read "spec/examples/vcalendar/values.ics"
  ...
  it 'should parse iCalendar properly Atikokan.ics' do
    ...
    vobj_json = Vcalendar.parse(ics, true).to_json
    exp_json = JSON.load(File.read "spec/examples/vcalendar/timezones/America/Atikokan.json")
    expect(vobj_json).to include_json(exp_json)
  end
  ...
  it 'should parse iCalendar properly Denver' do
    ...
    vobj_json = Vcalendar.parse(ics, true).to_json
    exp_json = JSON.load(File.read "spec/examples/vcalendar/timezones/America/Denver.json")
    expect(vobj_json).to include_json(exp_json)
  end
  ...
  it 'should parse iCalendar properly LA' do
    ...
    vobj_json = Vcalendar.parse(ics, true).to_json
    exp_json = JSON.load(File.read "spec/examples/vcalendar/timezones/America/Los_Angeles.json")
    expect(vobj_json).to include_json(exp_json)
  end
  ...
  it 'should parse iCalendar properly NYC' do
    ...
    vobj_json = Vcalendar.parse(ics, true).to_json
    exp_json = JSON.load(File.read "spec/examples/vcalendar/timezones/America/New_York.json")
    expect(vobj_json).to include_json(exp_json)
  end
  ...
  it 'should parse iCalendar properly RDATE_test.ics' do
    ...
    vobj_json = Vcalendar.parse(ics, true).to_json
    exp_json = JSON.load(File.read "spec/examples/vcalendar/timezones/Makebelieve/RDATE_test.json")
    expect(vobj_json).to include_json(exp_json)
  end
  ...
  it 'should parse iCalendar properly RDATE_utc_test.ics' do
    ...
    vobj_json = Vcalendar.parse(ics, true).to_json
    exp_json = JSON.load(File.read "spec/examples/vcalendar/timezones/Makebelieve/RDATE_utc_test.json")
    expect(vobj_json).to include_json(exp_json)
  end
  ...
  it 'should parse iCalendar properly RRULE_UNTIL_test.ics' do
    ...
    vobj_json = Vcalendar.parse(ics, true).to_json
    exp_json = JSON.load(File.read "spec/examples/vcalendar/timezones/Makebelieve/RRULE_UNTIL_test.json")
    expect(vobj_json).to include_json(exp_json)
  end
...
describe Vcard do
  ...
  it 'should roundtrip VCF' do
    ...
    expect(normalise_vcard(roundtrip)).to eql(normalise_vcard(ics))
  end
